...
void checkout()
{
    int menu_opcao_1, menu_opcao_2, buscar_id_reserva, id, numero, total_dias, busca_id, metodo_pagamento, tipo_cartao, opcao_confirmar_pagamento;
    char nome_cliente[50], data_entrada[11], data_saida[11], hora_entrada[6], hora_saida[6], status_pagamento[20], status[20];
    float valor_total, valor_pago, valor_q;
